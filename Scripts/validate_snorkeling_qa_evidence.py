...
CATALOG_ENTRIES = [
    ...
    ("SNK-QA-022", "SNORKELING_MAP_TYPE_DEFAULT_SATELLITE"),
    ("SNK-QA-023", "SNORKELING_MAP_TYPE_EXPLORE_SELECTION"),
    ("SNK-QA-024", "SNORKELING_MAP_TYPE_ROUTE_PLANNER_RENDERING"),
    ("SNK-QA-025", "SNORKELING_MAP_TYPE_SESSION_DETAIL_RENDERING"),
]
