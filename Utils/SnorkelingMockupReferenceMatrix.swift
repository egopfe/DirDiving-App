...
/// Raster mockups live under `Docs/ReferenceUI/Snorkeling/` only — never in app bundles.
...
enum SnorkelingMockupReferenceMatrix {
    static let all: [SnorkelingMockupReference] = [
        ...
        .init(id: "SNORKELING_IOS_01", fileName: "SNORKELING_IOS_01_DASHBOARD.png", platform: .ios, implementationReference: "iOSApp/Views/Snorkeling/IOSSnorkelingDashboardView.swift", hasExecutableFixture: false),
        .init(id: "SNORKELING_IOS_02", fileName: "SNORKELING_IOS_02_ROUTE_PLANNER.png", platform: .ios, implementationReference: "iOSApp/Views/Snorkeling/IOSSnorkelingRoutePlannerView.swift", hasExecutableFixture: false),
        .init(id: "SNORKELING_IOS_03", fileName: "SNORKELING_IOS_03_SESSION_DETAIL.png", platform: .ios, implementationReference: "iOSApp/Views/Snorkeling/IOSSnorkelingSessionDetailView.swift", hasExecutableFixture: false),
    ]
    ...
    static func referencePNGExists(at repositoryRoot: URL) -> [String] {
        all.compactMap { reference in
            let path = repositoryRoot
                .appendingPathComponent("Docs/ReferenceUI/Snorkeling")
