# Physical QA — SNORKELING_SAFETY_REVIEW

| Field | Value |
|-------|-------|
| **QA ID** | SNK-QA-007 |
| **Command category** | SNORKELING_SAFETY_REVIEW |
| **Status** | **PENDING** |
| **Branch** | (record at execution) |
| **Commit** | (record at execution) |
| **Purpose** | Safety copy, disclaimers, non-certified navigation truthfulness |
| **Required device** | iPhone + Watch |
| **Tester** | |
| **Reviewer** | |
| **Execution date** | |
| **iPhone model** | |
...
2. Execute the scenario for **SNORKELING_SAFETY_REVIEW** per `PROCEDURE.md` when present.
