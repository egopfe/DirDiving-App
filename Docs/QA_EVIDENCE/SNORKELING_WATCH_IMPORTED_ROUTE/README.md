# Physical QA — SNORKELING_WATCH_IMPORTED_ROUTE
...
| **Purpose** | Watch activates imported route package with planning metadata |
...
Valid route package pushed from iOS

## Test steps

1. Install the build at the recorded commit SHA.
2. Execute the scenario for **SNORKELING_WATCH_IMPORTED_ROUTE** per `PROCEDURE.md` when present.
