# Physical QA — SNORKELING_WATCH_GPS_QUALITY
...
| **Purpose** | Watch GPS Good/Medium/Poor/Lost presentation bands |
...
Outdoor + degraded GPS scenarios

## Test steps

1. Install the build at the recorded commit SHA.
2. Execute the scenario for **SNORKELING_WATCH_GPS_QUALITY** per `PROCEDURE.md` when present.
