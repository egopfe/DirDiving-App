# Physical QA — SNORKELING_IOS_ROUTE_SAFETY_CHECK
...
| **Purpose** | Route safety check states (ready/warning/incomplete/blocked) on iOS planner |
...
Multiple draft scenarios prepared

## Test steps

1. Install the build at the recorded commit SHA.
2. Execute the scenario for **SNORKELING_IOS_ROUTE_SAFETY_CHECK** per `PROCEDURE.md` when present.
