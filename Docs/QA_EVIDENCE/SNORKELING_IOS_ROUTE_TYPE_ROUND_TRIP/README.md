# Physical QA — SNORKELING_IOS_ROUTE_TYPE_ROUND_TRIP
...
| **Purpose** | Round trip route type auto-return leg and validation |
...
Entry point only round trip draft

## Test steps

1. Install the build at the recorded commit SHA.
2. Execute the scenario for **SNORKELING_IOS_ROUTE_TYPE_ROUND_TRIP** per `PROCEDURE.md` when present.
