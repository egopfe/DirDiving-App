# Physical QA — SNORKELING_VOICEOVER

| Field | Value |
|-------|-------|
| **QA ID** | SNK-QA-008 |
| **Command category** | SNORKELING_VOICEOVER |
| **Status** | **PENDING** |
| **Branch** | (record at execution) |
| **Commit** | (record at execution) |
| **Purpose** | VoiceOver on Watch and iOS Snorkeling surfaces |
| **Required device** | Physical iPhone + Watch |
| **Tester** | |
| **Reviewer** | |
| **Execution date** | |
| **iPhone model** | |
...
VoiceOver enabled; EN and IT spot checks

## Test steps

1. Install the build at the recorded commit SHA.
2. Execute the scenario for **SNORKELING_VOICEOVER** per `PROCEDURE.md` when present.
