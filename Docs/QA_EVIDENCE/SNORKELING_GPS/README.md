# Physical QA — SNORKELING_GPS

| Field | Value |
|-------|-------|
| **QA ID** | SNK-QA-010 |
| **Command category** | SNORKELING_GPS_ACCURACY |
| **Status** | **PENDING** |
| **Branch** | (record at execution) |
| **Commit** | (record at execution) |
| **Purpose** | GPS accuracy, degraded/unavailable presentation |
...
Outdoor or recorded GPS fixture

## Test steps

1. Install the build at the recorded commit SHA.
2. Execute the scenario for **SNORKELING_GPS** per `PROCEDURE.md` when present.
