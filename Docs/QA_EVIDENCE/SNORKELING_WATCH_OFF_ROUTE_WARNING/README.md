# Physical QA — SNORKELING_WATCH_OFF_ROUTE_WARNING
...
| **Purpose** | Off-route haptic when >50 m from route; paused when GPS lost |
...
Imported route; ability to walk off route outdoors

## Test steps

1. Install the build at the recorded commit SHA.
2. Execute the scenario for **SNORKELING_WATCH_OFF_ROUTE_WARNING** per `PROCEDURE.md` when present.
