# Physical QA — SNORKELING_HAPTICS
...
| **Purpose** | Haptic alarms and marker confirmation on Watch |
...
Haptics enabled in settings

## Test steps

1. Install the build at the recorded commit SHA.
2. Execute the scenario for **SNORKELING_HAPTICS** per `PROCEDURE.md` when present.
