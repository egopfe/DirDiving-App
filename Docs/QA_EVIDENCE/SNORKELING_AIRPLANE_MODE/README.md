# Physical QA — SNORKELING_AIRPLANE_MODE
...
| **Purpose** | Airplane mode sync deferral and recovery |
...
2. Execute the scenario for **SNORKELING_AIRPLANE_MODE** per `PROCEDURE.md` when present.
