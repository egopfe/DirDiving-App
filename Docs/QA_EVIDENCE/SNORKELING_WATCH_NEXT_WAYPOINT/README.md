# Physical QA — SNORKELING_WATCH_NEXT_WAYPOINT
...
| **Purpose** | Watch next waypoint distance/bearing and reached indication |
...
Imported route with ≥2 waypoints; outdoor GPS

## Test steps

1. Install the build at the recorded commit SHA.
2. Execute the scenario for **SNORKELING_WATCH_NEXT_WAYPOINT** per `PROCEDURE.md` when present.
