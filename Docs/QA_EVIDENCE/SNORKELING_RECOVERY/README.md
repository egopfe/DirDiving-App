# Physical QA — SNORKELING_RECOVERY
...
| **Purpose** | Session recovery after crash or force-quit |
...
Active Snorkeling checkpoint on disk

## Test steps

1. Install the build at the recorded commit SHA.
2. Execute the scenario for **SNORKELING_RECOVERY** per `PROCEDURE.md` when present.
