# Physical QA — SNORKELING_EXPORT

| Field | Value |
|-------|-------|
| **QA ID** | SNK-QA-016 |
| **Command category** | SNORKELING_EXPORT |
| **Status** | **PENDING** |
| **Branch** | (record at execution) |
| **Commit** | (record at execution) |
| **Purpose** | Session export formats and share sheet |
...
Completed Snorkeling session in Logbook

## Test steps

1. Install the build at the recorded commit SHA.
2. Execute the scenario for **SNORKELING_EXPORT** per `PROCEDURE.md` when present.
