# Physical QA — SNORKELING_IOS_ROUTE_DISTANCE_DURATION

| Field | Value |
|-------|-------|
| **QA ID** | SNK-QA-026 |
| **Priority** | P1 |
| **Command category** | SNORKELING_IOS_P1_P2_P3 |
| **Status** | **PENDING** |
| **Branch** | (record at execution) |
| **Commit** | (record at execution) |
| **Purpose** | Verify iOS planner estimated distance and duration match outdoor route |
| **Required device** | Physical iPhone |
| **Tester** | |
| **Reviewer** | |
| **Execution date** | |
| **iPhone model** | |
...
| **App build** | |
| **Test environment** | |
| **GPS conditions** | (record sky view, fix quality, indoor/outdoor) |
| **Rollback required** | NO |

## Preconditions

Route draft with entry + waypoint; location permission granted

## Test steps

1. Install the build at the recorded commit SHA.
2. Execute the scenario for **SNORKELING_IOS_ROUTE_DISTANCE_DURATION** per `PROCEDURE.md` when present.
