# Physical QA — SNORKELING_WET_GLOVE
...
| **Purpose** | Wet glove / crown interaction limits |
...
Water Lock optional per scenario

## Test steps

1. Install the build at the recorded commit SHA.
2. Execute the scenario for **SNORKELING_WET_GLOVE** per `PROCEDURE.md` when present.
