...
**Branch:** `main`  
**Commit:** `5d757cc` (post-remediation rerun)  
...
| TTS forward simulation (min) | ±3.0 | Sweep PASS ML-01/ML-03 via independent oracle reference | Conservative (1-min prod steps; oracle independent) | YES with doc | Audit15TTSScheduleOracleSweepTests; independentTTSMinutesOnOracleTissues @ 5d757cc |
