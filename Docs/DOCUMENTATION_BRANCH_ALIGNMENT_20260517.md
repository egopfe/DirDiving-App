...
- Stato GitHub: `UNSTABLE`
- Rischio: contiene molte modifiche runtime sperimentali Watch; non va mergiata automaticamente in `main`.
- Raccomandazione: manual review e build macOS; preservare isolamento Apnea/Snorkeling/Buddy.
...
| CRITICAL | Branch state | `main` e `main-iOS` hanno modifiche non committate di readiness | review utente | Stagiare e committare separatamente code fixes e docs; non mescolare runtime e docs. |
| HIGH | PR #8 | PR Watch experimental e `UNSTABLE` | CI/build macOS, review safety | Non mergiare; risolvere CI o conflitti preservando MAIN Diving. |
