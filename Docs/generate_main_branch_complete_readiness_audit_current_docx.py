# -*- coding: utf-8 -*-
"""Generate MAIN_BRANCH_COMPLETE_READINESS_AUDIT_CURRENT.docx from markdown."""
...
MD = HERE / "MAIN_BRANCH_COMPLETE_READINESS_AUDIT_CURRENT.md"
OUT = HERE / "MAIN_BRANCH_COMPLETE_READINESS_AUDIT_CURRENT.docx"
...
def build_doc() -> Document:
    ...
    _add_paragraph(
        doc,
        "Current pre-modification readiness audit export. Source: MAIN_BRANCH_COMPLETE_READINESS_AUDIT_CURRENT.md",
        bold=True,
        size=10,
    )
