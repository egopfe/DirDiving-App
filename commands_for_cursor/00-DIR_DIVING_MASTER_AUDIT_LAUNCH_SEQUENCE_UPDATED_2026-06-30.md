...
Run seventh, after the six domain audits and after any software remediation command has been executed.

Reason: this command verifies whether remediation outputs, code changes, tests, scripts and documentation actually close the software-actionable findings without falsely closing physical, external, legal or App Store gates.
