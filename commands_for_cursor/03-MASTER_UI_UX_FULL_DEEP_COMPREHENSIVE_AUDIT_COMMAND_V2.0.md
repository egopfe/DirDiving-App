...
**Launch order note:** THIRD — UI/UX audit. Run after core logic audits so the UI/UX review can verify that implemented behavior is reachable, truthful, activity-owned and visually coherent.

**Canonical numbered filename:** `03-MASTER_UI_UX_FULL_DEEP_COMPREHENSIVE_AUDIT_COMMAND_V2.0.md`

---

# MASTER CURSOR / CODEX COMMAND — DIR DIVING UI/UX FULL DEEP COMPREHENSIVE AUDIT — V2.0
