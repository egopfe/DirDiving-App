...
**Canonical numbered filename:** `07-MASTER_POST_REMEDIATION_CODE_READINESS_VERIFICATION_AUDIT_COMMAND_V1.5.md`

---

# MASTER CURSOR / CODEX COMMAND — DIR DIVING POST-REMEDIATION CODE READINESS VERIFICATION AUDIT — V1.5
...
# V1.5 POST-REMEDIATION VERIFICATION ORDER
