...
**Canonical numbered filename:** `04-MASTER_MAIN_CODE_SYNC_SECURITY_PERFORMANCE_AUDIT_COMMAND_V1.6.md`

---

# MASTER CURSOR / CODEX COMMAND — DIR DIVING MAIN CODE / SYNC / SECURITY / PERFORMANCE AUDIT — V1.6
...
commands_for_cursor/07-MASTER_POST_REMEDIATION_CODE_READINESS_VERIFICATION_AUDIT_COMMAND_V1.6.md
```
...
# V1.6 MAIN CODE / SYNC / SECURITY SCOPE — GPS, UNIFIED LOGBOOK AND TEST EVIDENCE
