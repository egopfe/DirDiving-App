...
**Canonical numbered filename:** `05-MASTER_RELEASE_QA_EVIDENCE_COMPLIANCE_AUDIT_COMMAND_V1.0.md`

---

# MASTER CURSOR / CODEX COMMAND — DIR DIVING RELEASE / QA / EVIDENCE / LEGAL CLAIMS AUDIT — V1.0
