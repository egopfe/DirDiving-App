...
```text
00-MASTER_SUPER_ORCHESTRATOR_FULL_AUDIT_SEQUENCE_AND_NON_REGRESSIVE_REMEDIATION_PLAN_COMMAND_V1.5.md
```

This version is aware of the 2026-06-27 / 2026-06-30 development wave: water auto-open, submerged system launch, Digital Crown underwater clamp, Action Button router policy, Watch cold-launch fix, Full Computer GF presets, shallow-depth entitlement and developer shallow-depth testing toggles.



## 01 — Watch Full Computer Forensic Audit

**Priority:** highest-risk, non-derogable algorithmic/mathematical safety gate. If this audit has unresolved P0/P1 math/decompression findings, no later audit may mark readiness as positive.
...
The `07` command is **not** part of the `00` pre-remediation orchestrator sequence.

Use `07` only after:

```text
1. 00 has produced the consolidated audit and remediation plan
2. the remediation command has been executed
3. remediation outputs exist in Docs/
```
