...
struct GPSStartRegisteredView: View {
    ...
    private var titleText: String {
        ...
        return isFallback ? "ULTIMO PUNTO NOTO\nUTILIZZATO" : "PUNTO INIZIO\nREGISTRATO"
    }

    private var detailText: String {
        guard point != nil else { return "Avvio senza coordinate GPS valide." }
        return isFallback ? "Fix nuovo non disponibile. Avvio con ultimo punto noto." : "Avvio immersione in corso..."
    }
