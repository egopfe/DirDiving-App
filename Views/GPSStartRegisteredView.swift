...
struct GPSStartRegisteredView: View {
    ...
    private var latitudeText: String {
        guard let point else {
            // TODO: Use the captured start GPS latitude when this view receives live dive context.
    ...
    private var longitudeText: String {
        guard let point else {
            // TODO: Use the captured start GPS longitude when this view receives live dive context.
