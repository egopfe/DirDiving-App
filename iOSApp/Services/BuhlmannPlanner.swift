...
enum BuhlmannPlanner {
    ...
    static func plan(depthMeters: Double, o2Fraction: Double) -> BuhlmannPlanResult {
        ...
        return BuhlmannPlanResult(depthMeters: depthMeters, gasO2Fraction: o2Fraction, nitrogenFraction: fn2, ndlMinutes: ndlValue, curve: curve, warning: ndlValue <= 0 ? "Fuori curva secondo modello semplificato." : nil)
    }
